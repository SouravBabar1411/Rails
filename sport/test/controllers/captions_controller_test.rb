...
class CaptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create caption" do
    assert_difference('Caption.count') do
      post captions_url, params: { caption: { caption_country: @caption.caption_country, caption_name: @caption.caption_name, caption_sport: @caption.caption_sport } }
    end
  ...
  test "should update caption" do
    patch caption_url(@caption), params: { caption: { caption_country: @caption.caption_country, caption_name: @caption.caption_name, caption_sport: @caption.caption_sport } }
