...
class LoginsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create login" do
    assert_difference('Login.count') do
      post logins_url, params: { login: { password: @login.password, user_name: @login.user_name } }
    end
  ...
  test "should update login" do
    patch login_url(@login), params: { login: { password: @login.password, user_name: @login.user_name } }
